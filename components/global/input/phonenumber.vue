  ...
  >
    ...
    <div class="inline-flex w-full">
      ...
      <multiselect
        ...
        "
        class="text-dark block !w-[30%] !rounded-[9px] border border-slate-300 bg-slate-50 shadow"
        :class="{
      ...
      <input
        ...
        :name="name"
        type="text"
        class="text-dark block w-[70%] rounded-[9px] border border-slate-300 bg-slate-50 shadow"
        :class="{
          '!dark:border-red-500 !border-red-500': !!errorMessage,
        }"
        :disabled="disabled"
