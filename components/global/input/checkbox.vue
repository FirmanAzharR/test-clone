<template>
  <div class="relative">
    ...
    <div
      v-if="isOpen"
      class="text-dark absolute left-0 top-10 z-20 mt-1 flex min-w-max flex-col divide-y rounded-lg border border-slate-300 bg-slate-50 shadow-md"
    >
...
const checkAll = () => {
  if (all_checked.value) {
    for (let checkbox of child_checkbox.value) {
